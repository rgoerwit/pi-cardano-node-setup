...
[ -z "${EXTERNAL_IPV4_ADDRESS}" ] && EXTERNAL_IPV4_ADDRESS="$(host -4 myip.opendns.com resolver1.opendns.com | tail -1 | awk '{ print $(NF) }')" 2> /dev/null
...
[ -z "${EXTERNAL_IPV6_ADDRESS}" ] && EXTERNAL_IPV6_ADDRESS="$(host -6 myip.opendns.com resolver1.opendns.com | tail -1 | awk '{ print $(NF) }' 1> /dev/null)" 2> /dev/null
